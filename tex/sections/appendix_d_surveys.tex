...
Fourteen corpus entries are themselves surveys or engine-comparison studies. The repository sets
them on one set of columns, recording what each work covers, not how well. This appendix reads
those columns out in prose. Section 1 states what this survey adds over them and does not repeat
the comparison here.
...
\IfFileExists{tables/surveys.tex}{\input{tables/surveys.tex}}{%
  \begin{table}[!t]
  \caption{The corpus's own surveys and engine-comparison studies, on one set of columns. Pending: the generated table.}
  \label{tab:surveys}
  \end{table}}
