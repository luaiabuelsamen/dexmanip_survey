...
\begin{figure}[!t]
  ...
  work. Further accusations an earlier draft made were withdrawn under adversarial review, each
  recorded in the accused row's \texttt{mismatch\_review} field beside the charge.
