...
%% with the finding it qualifies. Keep this one paragraph and at most about 200 words.
...
Third, experiments remain concentrated on four established hands while
eight hands that can be bought or built appear in no method paper in the corpus. The survey does
not rerun or rank methods. Instead, it identifies what current reports can support and proposes a
common evaluation protocol. Because missing information may reflect the extraction as well as the
source, all reporting counts should be read as lower bounds.
