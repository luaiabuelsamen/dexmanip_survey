...
plate. The other eleven are permission pending: two need a request through a publisher's own
process and nine need an email to the authors, arXiv's non-exclusive licence to distribute
granting a third party nothing. No caption prints that status, because a permission still to be
sought is a working note and not a finding. The register that records, per figure, the
