...
\textbf{What would close it.} One architecture carries three quarters of the field, and the choice
behind it has been compared twice, with opposite outcomes, and ablated once. What would close it is
one handover task run on three architectures with the same hand and the same seeds, reporting
