...
% Three reproduced plates survive in the whole paper; one of them is here, and
% it is the only one of the three already cleared under CC BY 4.0. Load
...
\caption{Four ways to control two dexterous hands, counted over the 28 corpus rows with a learned
closed-loop controller on two multi-fingered hands, each read from its note.}
\label{fig:bimanual}
\end{figure*}
