...
term its table weights at 0.1 is set to zero in the code, and its own success criterion could not
have detected that. Contact is what separates a hand from a gripper, and the obstacle to measuring
