...
\begin{tikzpicture}[
  ...
  key/.style={font=\tiny\ttfamily\color{black!58},anchor=west},
...
\node[key] at (8.45,-0.15) {physhoi\_2023, force\_grasp\_sim2real\_2026, dexman\_2025, and 17 more};
...
\node[key] at (8.45,-1.23) {visual\_dexterity\_2022, unidexgrasp\_2023, dexplore\_2025, and 13 more};
\fill[bar] (6.75,-1.68) rectangle (7.00,-1.57);
\node[num] at (7.85,-1.62) {5};
\node[ann] at (8.79,-1.53) {-- of which the student is a vision policy};
\node[key] at (8.79,-1.77) {hora\_2022, visual\_dexterity\_2022, rotateit\_2023, and 2 more};
...
\node[key] at (8.45,-2.85) {pianomime\_2024, dexmv\_2021, dextrack\_2025, dapg\_2017, and 2 more};
\fill[bar] (6.75,-3.66) rectangle (7.45,-3.54);
\node[num] at (7.85,-3.60) {14};
\node[lbl] at (8.45,-3.51) {teleoperated on the target robot};
\node[key] at (8.45,-3.75) {dexteleop0\_2026, dexora\_2026, open\_television\_2024, and 11 more};
...
\node[key] at (8.45,-4.29) {dexcap\_2024, dexumi\_2025, dexwild\_2025, umi\_2024};
\fill[bar] (6.75,-4.74) rectangle (7.10,-4.63);
\node[num] at (7.85,-4.68) {7};
\node[lbl] at (8.45,-4.59) {egocentric video, no robot at all};
\node[key] at (8.45,-4.83) {dexmv\_2021, videodex\_2022, dexvip\_2022, okami\_2024, and 3 more};
...
\node[key] at (8.79,-6.45) {diffusion\_policy\_2023, dp3\_2024, dexora\_2026, and 11 more};
\fill[bar] (6.75,-6.90) rectangle (7.15,-6.79);
\node[num] at (7.85,-6.84) {8};
\node[ann] at (8.79,-6.75) {-- flow matching};
\node[key] at (8.79,-6.99) {pi0\_2024, groot\_n1\_2025, h\_rdt\_2025, pistar06\_2025, and 4 more};
...
\node[key] at (8.45,-8.43) {dextrack\_2025, maniptrans\_2025, dexmachina\_2025, toporetarget\_2026};
