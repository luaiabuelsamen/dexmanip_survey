...
source: https://github.com/NVlabs/dex-ycb-toolkit


commit: 64551b001d360ad83bc383157a559ec248fb9100
...
dex_ycb_toolkit/
  ...
  window.py
examples/
  all_cvpr2021_results_eval_scripts.sh
  create_dataset.py
  evaluate_bop.py
  evaluate_coco.py
  evaluate_grasp.py
...
manopth/
results/
  fetch_cvpr2021_results.sh
  fetch_example_results.sh
setup.py
```
