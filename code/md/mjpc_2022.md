...
commit: ff572a21e7c2bf9fda62e1862a758da7e9a8719b
...
### mjpc/tasks/manipulation/merge_panda_robotiq.py
...
```
def make_instruction(m, d)
def get_models_and_cost_fn()
```

### python/mujoco_mpc/mjx/tasks/insert.py
...
### python/mujoco_mpc/mjx/tasks/instruction.py

```
class ObjectInstruction()
class Instruction()
def instruction_cost(m, d, instruction)
```