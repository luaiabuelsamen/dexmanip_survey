...
source: https://github.com/oakink/OakInk2


commit: 502a02809b50b7f5d0037f92a1ccd2a479051ad1
...
asset/
  smplx_extra/
    body_left_hand_closed_idx.pt
    body_left_hand_idx.pt
    body_right_hand_closed_idx.pt
    body_right_hand_idx.pt
    body_upper_idx.pt
config/
  gui__preview.yml
doc/
  logo@2x-80.png
  oakink2_preview_tool.gif
  teaser.jpg
req_preview.txt
req_toolkit.txt
script/
  download.py
  restore_git_submodule.sh
setup.py
src/
  oakink2_preview/
    __init__.py
...
### config/gui__preview.yml

```yaml
viz:
  stream_prefix: data/data
  anno_prefix: data/anno_preview
  object_prefix: data/object_repair
  program_prefix: data/program
```

## Python signatures and reward/observation bodies (3 files)


### src/oakink2_preview/util/upkeep/env.py
...
### src/oakink2_toolkit/structure/complex_task.py

```
class OakInk2__ComplexTask(NamedData)
```

### src/oakink2_toolkit/structure/primitive_task.py
