# DexHand: An Open Source Dexterous Humanoid Robot Hand

source entry: dexhand_open_source_2023
...
[](http://www.therobotstudio.com) | The DexHand was envisioned and released to Open Source by [Rob Knight of The Robot Studio](https://www.therobotstudio.com). This remarkable work is one of many amazing projects Rob has created in over 20 years in robotics.  
---|---  
[](http://www.iotdesignshop.com) | This site and content is maintained by [Trent Shumay from IoT Design Shop](http://www.iotdesignshop.com). Trent has built and tuned a DexHand in the IoT Shop and made it a goal to document this process.  
...
###  [ Initial Release of ROS 2 Support for DexHand ](/software/firmware/ros2/update/2023/10/01/ros-2-package-release.html)

  * Aug 27, 2023

###  [ Electronics Build Instructions Released to Build Wiki ](/electronics/build/update/2023/08/27/electronics-build-steps.html)

  * Aug 8, 2023

###  [ BLE Firmware Released to GitHub ](/firmware/update/2023/08/08/ble-firmware-release.html)
...
## DexHand - An Open Source Dexterous Humanoid Robot Hand
  ...
  * DexHand - An Open Source Dexterous Humanoid Robot Hand
  * [info@dexhand.org](mailto:info@dexhand.org)
...
The DexHand is an Open Source Dexterous Humanoid Robot Hand. It is intended to be a low-cost R&D platform for exploring grasping and manipulation for robots intending to use humanoid hands as their interface to the world. 
