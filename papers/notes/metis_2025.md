...
- reward or loss (quoted):
  - "The auto-regressive objective of METIS π is to minimize the sum of next-dynamics negative log-probabilities" (Sec 4.3) — equation itself is an unrendered figure/image in the extracted markdown; N = 44 tokens total, "4 for visual dynamics and 40 for motion dynamics" (Sec 4.3).
