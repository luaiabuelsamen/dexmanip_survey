...
def main():
    ...
    # Appendices B and C are generated by tools/make_appendices.py and already carry their own
    # heading, so they are appended whole. D and E are written by hand; D carries a table marker
    # and E carries the protocol derivation moved out of section 7.3.
    # A missing one is reported rather than silently skipped.
